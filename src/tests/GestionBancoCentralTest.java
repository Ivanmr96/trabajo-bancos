...
public class GestionBancoCentralTest 
{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("gestion.realizarMovimiento(\"ESPCAIXESBBXXX0000000\", \"ESPINGDESMMXXX0000000\", \"test_realizarMovimiento\", 200, fechaActual)");
		...
		System.out.println("-------------------------------------------");
		//TODO Revisar esta parte del test
