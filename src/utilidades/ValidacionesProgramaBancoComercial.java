...
public class ValidacionesProgramaBancoComercial 
{
	 ...
	 * Entrada: un String con el BIC del banco donde se comprobar� si el DNI existe o no
	...
	public String LeerYValidarIBANCliente(String BIC)
	{
		...
		do
		{
			...
			IBAN = teclado.next();
			BICInsertado = gestion.obtenerBICporIBAN(IBAN);			//TODO Aqui salta StringIndexOutOfBoundsException si se introduce una cadena mas peque�a.
		...
		if(gestion.isIBANParaBorrar(IBAN)){
			System.out.println("Esta cuenta est� marcada como borrada.");
		}
	 ...
	 * Comentario: pide y valida un a�o
	 * Precondiciones:
	 * Entradas:
	 * Salidas: int
	 * Postcondiciones: asociado al nombre se devuelve un a�o
	 * */
	public int anyo(){
	 ...
	 * Comentario: pide y valida un mes. El mes 0 significa que el usuario no desea tener en cuenta el mes en la b�squeda.
	 * Precondiciones:
	 * Entradas:
	 * Salidas: int
	 ...
	 * Comentario: pide y valida un dia. El dia 0 significa que el usuario no desea tener en cuenta el dia en la b�squeda.
	 * Precondiciones:
	 * Entradas:
	 * Salidas: int
