...
public class Utilidades {
    ...
    * */
     ...
     * 				    Un DNI es v�lido cuando:
     * 					- Es una cadena de tama�o 10
     * 					- Los 8 primeros caracteres son num�ricos.
     * 					- El caracter noveno es el caracter separador, y es un "-"
     * 					- El �ltimo caracter es una letra que se corresponde con el resto de la divisi�n de la parte n�merica entre 23.
     */
